...
public class LoginScreen implements Screen {
    ...
    public LoginScreen(Main game, BitmapFont font, Texture buttonTexture, Texture backgroundTexture, Music theme, OrthographicCamera gamecam, Viewport gameport) {
        this.game = game;
        ...
        LoginButton.setSize(120, 80);
        backButton.setSize(120, 80);

        LoginButton.setPosition((gameport.getWorldWidth() - LoginButton.getWidth()) / 2, (gameport.getWorldHeight() / 2 )+60);
